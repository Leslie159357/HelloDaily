...
if __name__ == "__main__":
    ...
    latest_link = f"[📅 **今日精选**](content/{filename})"
    with open(readme_path, "w", encoding="utf-8") as f:
        today_str = date.today().isoformat()
        f.write(f"# HelloDaily\n> 每日开源精选，自动推送 GitHub Trending\n\n## 最新一期\n\n{latest_link} · {today_str}\n\n## 关于\n\n每天自动抓取 GitHub Trending，按语言分类生成精选列表。\n")
    print(f"✅ README 已更新")
    print(f"\n📊 本期概览:")
    by_lang = {}
    for r in repos:
