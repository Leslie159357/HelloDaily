...
1、[bleachbit/bleachbit](https://github.com/bleachbit/bleachbit) 🌟 6,082
   免费开源的磁盘清理工具。这是一款适用于 Windows 和 Linux 的开源磁盘清理工具，可用于清除临时文件、浏览器缓存、Cookies、浏览历史等，并支持安全删除、文件粉碎和批量自动清理等功能。

2、[liaohch3/claude-tap](https://github.com/liaohch3/claude-tap) 🌟 2,184
...
4、[Andyyyy64/whichllm](https://github.com/Andyyyy64/whichllm) 🌟 5,425
...
5、[cupy/cupy](https://github.com/cupy/cupy) 🌟 11,826
   NumPy & SciPy for GPU

6、[soxoj/maigret](https://github.com/soxoj/maigret) 🌟 34,381
   🕵️‍♂️ Collect a dossier on a person by username from 3000+ sites

7、[commaai/openpilot](https://github.com/commaai/openpilot) 🌟 62,774
   openpilot is an operating system for robotics. Currently, it upgrades the driver assistance system on 300+ supported cars.

8、[xbtlin/ai-berkshire](https://github.com/xbtlin/ai-berkshire) 🌟 6,626
...
9、[browser-use/video-use](https://github.com/browser-use/video-use) 🌟 11,948
   Edit videos with coding agents

10、[Unclecheng-li/VulnClaw](https://github.com/Unclecheng-li/VulnClaw) 🌟 1,138
   基于 AI Agent + MCP 工具链 + 渗透 Skill 编排， 配合大语言模型， 自然语言输入 → 自动完成「信息收集 → 漏洞发现 → 漏洞利用 → 报告生成」全流程。

11、[HKUDS/Vibe-Trading](https://github.com/HKUDS/Vibe-Trading) 🌟 15,098
...
2、[drizzle-team/drizzle-orm](https://github.com/drizzle-team/drizzle-orm) 🌟 34,983
...
3、[millionco/react-doctor](https://github.com/millionco/react-doctor) 🌟 13,212
...
5、[webadderallorg/Recordly](https://github.com/webadderallorg/Recordly) 🌟 18,365
   支持自动缩放和光标特效的屏幕录制工具。这是一款开源的桌面屏幕录制与编辑工具，内置基于鼠标活动的自动缩放、光标平滑和美化效果，支持摄像头画面、自定义壁纸、拖拽时间轴编辑等功能，适用于 Windows、macOS 和 Linux 平台。

### 🤖 人工智能

1、[rohitg00/agentmemory](https://github.com/rohitg00/agentmemory) 🌟 24,303
...
2、[rohitg00/ai-engineering-from-scratch](https://github.com/rohitg00/ai-engineering-from-scratch) 🌟 36,833
...
3、[getagentseal/codeburn](https://github.com/getagentseal/codeburn) 🌟 8,332
...
4、[nexu-io/open-design](https://github.com/nexu-io/open-design) 🌟 72,941
...
5、[tinyhumansai/openhuman](https://github.com/tinyhumansai/openhuman) 🌟 33,874
...
1、[yaoyao2mm/cheatreader](https://github.com/yaoyao2mm/cheatreader) 🌟 492
...
2、[HermannBjorgvin/Clawdmeter](https://github.com/HermannBjorgvin/Clawdmeter) 🌟 1,725
...
3、[anomalyco/models.dev](https://github.com/anomalyco/models.dev) 🌟 5,563
...
5、[vercel-labs/zerolang](https://github.com/vercel-labs/zerolang) 🌟 5,146
...
3、[homeport/termshot](https://github.com/homeport/termshot) 🌟 933
   一条命令生成终端截图。这是一款用 Go 语言开发的命令行工具，能够将终端的文本内容转换为带有语法高亮和窗口边框的截图。使用时只需在命令前加上 termshot 即可，支持自定义字体、显示执行命令、即时预览、去除窗口装饰和阴影等功能。

4、[pranshuparmar/witr](https://github.com/pranshuparmar/witr) 🌟 18,044
...
1、[steipete/CodexBar](https://github.com/steipete/CodexBar) 🌟 15,523
...
2、[lifedever/health-tick-release](https://github.com/lifedever/health-tick-release) 🌟 311
...
3、[darrylmorley/whatcable](https://github.com/darrylmorley/whatcable) 🌟 6,222
   这根 USB-C 线到底能干啥。这是一款能够识别插在 Mac 上的 USB-C 线能充多快、传多快的工具，可显示传输速率、充电速度、功率上限、E-Marker 芯片厂商等信息。

4、[altic-dev/FluidVoice](https://github.com/altic-dev/FluidVoice) 🌟 4,396
   FluidVoice - Fastest macOS Offline Dictation app - Voice to Text fully Local. One ⭐ takes us a long way :))

### 💠 C

1、[antirez/ds4](https://github.com/antirez/ds4) 🌟 16,801
...
2、[yhzhang0128/egos-2000](https://github.com/yhzhang0128/egos-2000) 🌟 3,349
...
3、[veracrypt/VeraCrypt](https://github.com/veracrypt/VeraCrypt) 🌟 10,480
   Disk encryption with strong security based on TrueCrypt

### 🎯 C#

1、[Dailin521/codex-provider-sync](https://github.com/Dailin521/codex-provider-sync) 🌟 2,458
...
2、[unchihugo/FluentFlyout](https://github.com/unchihugo/FluentFlyout) 🌟 3,304
...
3、[shanselman/PeekDesktop](https://github.com/shanselman/PeekDesktop) 🌟 728
...
1、[t8y2/dbx](https://github.com/t8y2/dbx) 🌟 7,628
...
2、[unhappychoice/gittype](https://github.com/unhappychoice/gittype) 🌟 1,476
   把代码变成打字游戏的工具。这是一款能够将你写的代码或 GitHub 项目转换成打字挑战的工具，支持 Rust、TypeScript、Python 等编程语言，并提供实时准确率统计和多种游戏模式，适合在练习键盘输入时顺便熟悉代码。的分享

3、[gyroflow/gyroflow](https://github.com/gyroflow/gyroflow) 🌟 9,102
...
1、[heygen-com/hyperframes](https://github.com/heygen-com/hyperframes) 🌟 32,178
...
2、[tw93/Kami](https://github.com/tw93/Kami) 🌟 9,310
   让 AI 生成的文档值得被打印出来。该项目是面向 AI 编程工具的文档排版设计技能包，解决 AI 生成文档排版不好看、风格不一的问题。内置 10 种文档模板，包括一页纸、简历、幻灯片、作品集和落地页等。

3、[mattpocock/skills](https://github.com/mattpocock/skills) 🌟 150,534
...
2、[0xNyk/council-of-high-intelligence](https://github.com/0xNyk/council-of-high-intelligence) 🌟 1,902
...
1、[logto-io/logto](https://github.com/logto-io/logto) 🌟 12,676
...
2、[refactoringhq/tolaria](https://github.com/refactoringhq/tolaria) 🌟 17,518
   Desktop app to manage markdown knowledge bases

### 📦 Haskell

1、[simplex-chat/simplex-chat](https://github.com/simplex-chat/simplex-chat) 🌟 16,593
   SimpleX - the first messaging network operating without user identifiers of any kind - 100% private by design! iOS, Android and desktop apps 📱!

### 🌐 HTML

1、[ripienaar/free-for-dev](https://github.com/ripienaar/free-for-dev) 🌟 126,730
