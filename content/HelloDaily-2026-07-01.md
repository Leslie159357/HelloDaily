...
4、[D4Vinci/Scrapling](https://github.com/D4Vinci/Scrapling) 🌟 67,415
...
6、[usestrix/strix](https://github.com/usestrix/strix) 🌟 28,143
   开源AI渗透测试工具，助你发现并修复应用漏洞。

7、[browser-use/video-use](https://github.com/browser-use/video-use) 🌟 12,621
   用代码代理编辑视频。

8、[xbtlin/ai-berkshire](https://github.com/xbtlin/ai-berkshire) 🌟 7,512
...
9、[Mebus/cupp](https://github.com/Mebus/cupp) 🌟 6,108
   常见用户密码分析工具（CUPP）。

10、[google/agents-cli](https://github.com/google/agents-cli) 🌟 4,210
   CLI工具包，助力编码助手成为Google Cloud AI代理专家。

11、[roboflow/supervision](https://github.com/roboflow/supervision) 🌟 45,919
   为您定制可复用的计算机视觉工具。💜

12、[HKUDS/Vibe-Trading](https://github.com/HKUDS/Vibe-Trading) 🌟 15,807
   "Vibe-Trading：您的个人交易助手"

13、[Robbyant/lingbot-map](https://github.com/Robbyant/lingbot-map) 🌟 8,879
   基于流数据的3D场景重建前馈基础模型
...
5、[refactoringhq/tolaria](https://github.com/refactoringhq/tolaria) 🌟 17,819
...
2、[XiaoLuoLYG/GOD](https://github.com/XiaoLuoLYG/GOD) 🌟 810
   AI 智能体小镇。这是一款本地优先的多智能体模拟和实时操控平台，不同于只能旁观的 Agent 模拟器，支持随时暂停/回放、注入干预指令、向单个或全体成员提问，以及一键重置整个模拟世界和多种地图包。的分享

3、[THU-MAIC/OpenMAIC](https://github.com/THU-MAIC/OpenMAIC) 🌟 19,147
...
2、[palemoky/fight-the-landlord](https://github.com/palemoky/fight-the-landlord) 🌟 401
...
4、[tinyauthapp/tinyauth](https://github.com/tinyauthapp/tinyauth) 🌟 7,675
...
1、[AlexsJones/llmfit](https://github.com/AlexsJones/llmfit) 🌟 28,915
...
2、[rerun-io/rerun](https://github.com/rerun-io/rerun) 🌟 11,030
...
4、[ogulcancelik/herdr](https://github.com/ogulcancelik/herdr) 🌟 9,035
   终端内的智能体多路复用器

### 🛠 Skills

1、[Imbad0202/academic-research-skills](https://github.com/Imbad0202/academic-research-skills) 🌟 35,557
...
2、[DietrichGebert/ponytail](https://github.com/DietrichGebert/ponytail) 🌟 69,134
...
4、[earthtojake/text-to-cad](https://github.com/earthtojake/text-to-cad) 🌟 7,335
...
1、[Ebullioscopic/Atoll](https://github.com/Ebullioscopic/Atoll) 🌟 2,582
...
3、[altic-dev/FluidVoice](https://github.com/altic-dev/FluidVoice) 🌟 4,937
   最快macOS听写工具，本地语音转文字+AI增强模型，Windows/iOS/Linux版即将推出。

### 🔷 TypeScript

1、[diegosouzapw/OmniRoute](https://github.com/diegosouzapw/OmniRoute) 🌟 8,554
   免费AI网关：集成231+服务商，连接多款编程助手，智能省流15-95%，支持多模态API。

2、[CoreBunch/Instatic](https://github.com/CoreBunch/Instatic) 🌟 1,545
   Instatic：现代化自托管可视化CMS，一分钟快速部署

3、[facebook/astryx](https://github.com/facebook/astryx) 🌟 1,801
   开源设计系统，完全可定制，支持智能体
...
1、[luanti-org/luanti](https://github.com/luanti-org/luanti) 🌟 13,111
...
1、[hasaneyldrm/exercises-dataset](https://github.com/hasaneyldrm/exercises-dataset) 🌟 6,711
   433种健身动作数据集，含名称、分类、目标肌群、器材、指导、示意图及动画视频。

2、[ripienaar/free-for-dev](https://github.com/ripienaar/free-for-dev) 🌟 127,333
   面向开发运维的免费SaaS/PaaS/IaaS服务清单。

### 🐚 Shell

1、[msitarzewski/agency-agents](https://github.com/msitarzewski/agency-agents) 🌟 120,962
   一站式AI代理团队：前端专家、社区运营、创意策划到实效审核，各具专长与个性。

2、[obra/superpowers](https://github.com/obra/superpowers) 🌟 242,535
   高效的智能体技能框架与开发方法论

### 🎯 C#

1、[snownico0722/PaperTodo](https://github.com/snownico0722/PaperTodo) 🌟 498
...
1、[simplex-chat/simplex-chat](https://github.com/simplex-chat/simplex-chat) 🌟 17,343
   SimpleX：首个无用户标识的消息网络，100%隐私设计！支持iOS、安卓及桌面应用📱

### 📦 Jupyter Notebook

1、[microsoft/AI-For-Beginners](https://github.com/microsoft/AI-For-Beginners) 🌟 49,390
   12周24课，全民AI计划！
